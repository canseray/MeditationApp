...
public class SQLiteHandler extends SQLiteOpenHelper {
    ...
    public SQLiteHandler(Context context){ //const duzenledik
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        String CREATE_TABLE = "CREATE TABLE " + TABLE_NAME + "("
                ...
                + KEY_BASLIK + "TEXT,"
                + KEY_ACIKLAMA +"TEXT,"
                + KEY_RESIM + "TEXT UNIQUE,"
                + KEY_SES + "TEXT UNIQUE,"
                + KEY_FAVORI + "INTEGER DEFAULT 0,"
                + KEY_TARIH + "TEXT,"
                + KEY_ANAHTAR + "INTEGER DEFAULT 0,"
                + KEY_ANAHTAR + "INTEGER DEFAULT 0)";
    ...
    public void veriEkle (String baslik,
                          String aciklama,
                          String resim,
                          String ses,
                          String tarih,
